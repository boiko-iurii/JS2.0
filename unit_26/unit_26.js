...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=-2&num2=5')
        .then(data => data.text())
        .then(data => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=-12&num2=5')
        .then(data => data.text())
        .then(data => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=5.5&num2=-1000')
        .then(data => data.text())
        .then(data => {
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=6&num2=4'
    })
        .then(response => response.text())
        .then(response => {
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=-6&num2=4'
    })
        .then(response => response.text())
        .then(response => {
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=10.5&num2=10.5000000000000001'
    })
        .then(response => response.text())
        .then(response => {
