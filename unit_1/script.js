...
document.querySelector('.three').innerHTML = '<h3>Lorem ipsum</h3>';
...
four.innerHTML = '<h4>Lorem ipsum</h4>';
four.innerHTML += '<p>dolor sit amet</p>';
...
let z1 = 6;
let z2 = 3;
document.querySelector('.fourteen').innerText = z1 * z2;
...
let y1 = 6;
let y2 = 3;
document.querySelector('.fifteen').innerText = y1 / y2;
...
let x1 = 'Hello';
let x2 = 5;
document.querySelector('.sixteen').innerText = x1 + x2;
