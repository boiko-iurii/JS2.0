...
function t2() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=2&name=Iurii", true);
    xhttp.send();
...
function t3() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=3&num2=9", true);
    xhttp.send();
...
function t4() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=2&num2=8", true);
    xhttp.send();
...
function t6() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=-5&num2=-6", true);
    xhttp.send();
...
function t8() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1986", true);
    xhttp.send();
...
function t9() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=9&m=1&d=0&y=0", true);
    xhttp.send();
...
function t10() {
    ...
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=1');
...
function t11() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=2&name=Iurii');
...
function t12() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=-5&num2=8');
...
function t13() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=-7&num2=3');
...
function t14() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=5');
...
function t15() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=-8&num2=8');
...
function t16() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=7');
...
function t17() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1986');
...
function t18() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=zhrgB3DxC8LoG7Gcisjc&action=9&m=1&d=1&y=1');
